...
var _inputJson = require("./input.json");
var _inputJsonDefault = parcelHelpers.interopDefault(_inputJson);
const calendarDiv = document.getElementById("calendar");
const inputTextarea = document.getElementById("json");
inputTextarea.value = JSON.stringify((0, _inputJsonDefault.default), null, 2);
drawCalendar(calendarDiv, (0, _inputJsonDefault.default));
...
function drawCalendar(element, input) {
    element.innerHTML = "";
    const instance = (width, _, events)=>new (0, _src.Matrix)(events, width);
    calendar = new (0, _src.Calendar)(calendarDiv.clientWidth, element.clientHeight, input, instance);
...
},{"./input.json":"g4313","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../../src":"hPpjy"}],"g4313":[function(require,module,exports) {
module.exports = JSON.parse('[{"id":"1","start":"2023-06-13T09:00:00","end":"2023-06-13T09:35:00"},{"id":"4","start":"2023-06-13T09:35:00","end":"2023-06-13T10:00:00"}]');
...
},{}],"hPpjy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Calendar", ()=>(0, _event.Calendar));
parcelHelpers.export(exports, "Slot", ()=>(0, _event.Slot));
parcelHelpers.export(exports, "Rectangle", ()=>(0, _event.Rectangle));
parcelHelpers.export(exports, "Matrix", ()=>(0, _layout.Matrix));
var _event = require("./event");
var _layout = require("./layout");

},{"./event":"fq2yE","./layout":"llvQK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fq2yE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"llvQK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Matrix", ()=>(0, _matrix.Matrix));
var _matrix = require("./matrix");

},{"./matrix":"ZR29A","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ZR29A":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Matrix {
    constructor(events, width){
        ...
        }).sort((e1, e2)=>e1.start.getTime() - e2.start.getTime()).sort((e1, e2)=>e1.end.getTime() - e2.end.getTime()).map((e)=>new (0, _.Slot)(e));
    ...
    #initMatrix(matrix, slot, i) {
        const startDate = (0, _.Slot).minute(slot.event.start);
        const endDate = (0, _.Slot).minute(slot.event.end);
...
},{"../":"hPpjy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["f3BSW","gLLPy"], "gLLPy", "parcelRequire8f3b")
